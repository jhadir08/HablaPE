...
GEMMA_MEDIA_SCHEMA="${HABLAPE_GEMMA_MEDIA_SCHEMA:-vllm}"
GEMMA_PROMPT_FORMAT="${HABLAPE_GEMMA_PROMPT_FORMAT:-gemma4}"
GEMMA_TIMEOUT_SECONDS="${HABLAPE_GEMMA_TIMEOUT_SECONDS:-30}"
GEMMA_MAX_OUTPUT_TOKENS="${HABLAPE_GEMMA_MAX_OUTPUT_TOKENS:-768}"
...
if [[ "$MODEL_PROVIDER" == "agent" ]]; then
  BACKEND_ENV+=(
    ...
    "HABLAPE_GEMMA_PROMPT_FORMAT=${GEMMA_PROMPT_FORMAT}"
    "HABLAPE_GEMMA_TIMEOUT_SECONDS=${GEMMA_TIMEOUT_SECONDS}"
    "HABLAPE_GEMMA_MAX_OUTPUT_TOKENS=${GEMMA_MAX_OUTPUT_TOKENS}"
